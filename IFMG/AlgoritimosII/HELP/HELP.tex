...
\begin{document}
	...
	\newpage
				...
				\section{Primeira Utilização}
					Ao iniciar o software será criada uma pasta chamada Arquivos no mesmo diretorio do executavel, dentro  da pasta Arquivos contem todos os arquivos de backup.\\
					\begin{figure}[h]
						\centering
					...
					\begin{figure}[h]
						\centering
						\includegraphics[height=3cm]{0.png}
						\caption{Backup's}
						\label{Backup's}
					\end{figure}
					...
					\begin{figure}[h]
						\centering
						\includegraphics[height=5cm]{4.png}
						\caption{Login}
						\label{Login}
					\end{figure}
				...
				\begin{figure}[h]
						\centering
						\includegraphics[height=5cm]{7.png}
						\caption{Ação}
						\label{Ação}
				\end{figure}
				...
				\begin{figure}[h]
						...
						\caption{Opçoes Reserva}
						\label{Opçoes Reserva}
				\end{figure}
				...
				\begin{figure}[h]
						...
						\caption{Switch Pesquisa}
						\label{Switch Pesquisa}
				\end{figure}
				...
				Para Exportar  e Importar é necessário informar a localização do arquivo xml porem quando importamos todo os dados importados sobrescrevem os antigos.\\
				...
				\begin{figure}[h]
						...
						\caption{Switch Exportação}
						\label{Switch Exportação}
				\end{figure}
