...
while(True):
    ...
    #Acabou as instancias do problema
    if(qtdVertices == 0 and qtdArestas == 0):
        break;
    ...
    direcional = True
    grafo = Grafo()
    grafo.listaAdjacencia(qtdVertices, arestas, direcional)

    #Calcula o custo do grafo original
    custoOriginal = grafo.custoGrafo()
    grafo.kruskal()
    #Calcula o custo da agm
    agm = grafo.agm
    custoAgm = agm.custoGrafo()    

    #Calcula a economia
    economia = int(custoOriginal - custoAgm)
    print(economia)
